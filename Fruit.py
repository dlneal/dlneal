...
john = 3  # John has 3 apples
mary = 5  # Mary has 5 apples
adam = 6  # Adam has 6 apples

# Step 2: Print the number of apples each person has
print(john, mary, adam)  # Show the numbers on one line

# Step 3: Add up all the apples
total_apples = john + mary + adam

# Step 4: Print the total number of apples
